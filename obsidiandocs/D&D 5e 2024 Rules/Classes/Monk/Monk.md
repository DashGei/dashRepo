...
| **Weapon Proficiencies**       | Simple weapons and Martial weapons that have the [[Rules/Properties/Light\|Light]] property                                                                                           |
| **Armor Training**             | None                                                                                                                                                                                  |
| **Starting Equipment**         | *Choose A or B:* (A) [[Spear]], 5 [[Dagger\|Daggers]], Artisan's Tools or [[Musical Instruments]] chosen for the tool proficiency above, [[Explorer's Pack]], and 11 GP; or (B) 50 GP |
### Becoming a Monk...
#### As a Level 1 Character
- Gain all the traits Core Monk Traits table
...
###### Monk Features
| Level | Proficiency<br>Bonus | Class Features                                       | Martial Arts | Focus Points | Unarmored Movement |
| :---: | :------------------: | ---------------------------------------------------- | :----------: | :----------: | :----------------: |
...
- Martial Melee weapons that have the [[Rules/Properties/Light|Light]] property
You gain the following benefits while you are unarmed or wielding only Monk weapons and you aren’t wearing armor or wielding a [[Equipment/Armor/Shield|Shield]].
...
While you aren’t wearing armor or wielding a [[Equipment/Armor/Shield|Shield]], your base Armor Class equals 10 plus your Dexterity and Wisdom modifiers.
...
Your speed increases by 10 feet while you aren’t wearing armor or wielding a [[Equipment/Armor/Shield|Shield]]. This bonus increases when you reach certain Monk levels, as shown on the Monk Features table.
...
You gain a Monk subclass of your choice. A subclass is a specialization that grants you features at certain Monk levels. For the rest of your career, you gain each of your subclass’s features that are of your Monk level or lower. The following subclasses are available for you to choose from:
