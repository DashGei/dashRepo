...
***Rotting Fist.*** *Melee Attack Roll:* +5, reach 5 ft. *Hit:* 8 (1d10 + 3) Bludgeoning damage plus 10 (3d6) Necrotic damage. If the target is a creature, it is [[Curses|cursed]]. While cursed, the target can't regain [[Hit Points]], its Hit Point maximum doesn't return to normal when finishing a [[Long Rest]], and its Hit Point maximum decreases by 10 (3d6) every 24 hours that elapse. A creature dies and turns to dust if reduced to 0 Hit Points by this attack.
