...
***Enlarge.*** The target's size increases by one category - from Medium to Large, for example. The target also has [[Advantage]] on Strength checks and Strength saving throws. The target's attacks with its enlarged weapons or [[Unarmed Strike|Unarmed Strikes]] deal an extra 1d4 damage on a hit.
