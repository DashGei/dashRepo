...
Choose any number of willing creatures that you can see within range. Each target [[Shape-Shifting|shape-shifts]] into a Large or smaller Beast of your choice that has a Challenge Rating of 4 or lower. You can choose a different form for each target. On later turns, you can take a [[Magic]] action to transform the targets again.
