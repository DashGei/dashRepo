...
tags:
  - magicitem
---
#### Dragon Orb [[Dragon Orb|(Priceless)]]
...
(The item is called the Orb of Dragonkind in the *Dungeon Master's Guide* which also includes additional information on using the Random Artifact Properties described in that book).
