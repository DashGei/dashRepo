...
- War Mage: You gain a +3 health bonus at each level.
...
- **Critical Witness:** You gain one Verse Die when you see a creature within 60 feet of you score a critical success or failure on an attack roll, saving throw, or ability check.
- **Knowledge Unveiled:** You gain one Verse Die when you see a creature within 60 feet of you succeed on an Intelligence (History, Arcana, Nature, or Religion) check with a DC of 15 or higher.
- **Tertiary Magic:** You gain one Verse Die when you see a creature within 60 feet of you complete the casting of a spell using a Tertiary Spell Slot.
- **Despair:** You gain one Verse Die when you see an allied creature within 60 feet of you fall unconscious.
- **DM's Discretion:** The DM can award you a Verse Die at any time for witnessing an act of particular bravery, cunning, folly, or narrative significance. This is encouraged.
...
- **Priest:** You gain a +2 health bonus at each level.
- **Holy Warrior:** You gain a +3 health bonus at each level.
...
- If the creature is willing, this movement succeeds automatically.
- If the creature is unwilling, it must succeed on a Physical DC Strength saving throw or be moved. You choose the direction of the movement.
...
- **Game Statistics:** Your game statistics are replaced by the Beast’s stat block, but you retain your creature type; Hit Points; Intelligence, Wisdom, and Charisma scores; class features; and languages. You also retain your skill and saving throw proficiencies and use your Proficiency Bonus for them, in addition to gaining the proficiencies of the creature. If a skill or saving throw modifier in the Beast’s stat block is higher than yours, use the one in the stat block.
...
- Beasts and plant creatures have disadvantage on attack rolls against you.
- You can use your action to attempt to calm a beast or plant creature within 30 feet that can see and hear you. The creature must make a Mental DC Wisdom saving throw. On a failure, it is charmed for 1 minute or until you or your allies damage it.

## Druid Circle: 3

At 3rd level, you choose a [Druid Circle](sc_druid.html) that shapes your connection to nature. Your choice grants features at 3rd, 6th, 10th, 14th, and 20th level.
...
At 9th level, you can use your Guiding Winds as an action.
...
|11th|+4|d8|Improved Divine Smite, Consecrated Ground|
...
You are so suffused with divine might that your melee weapon strikes carry supernatural power. Whenever you hit a creature with a melee weapon, the target takes an extra 1d4 radiant damage. This does not require spending Zeal Dice.

## Consecrated Ground: 11
...
- Casting a spell with a Primary Slot grants you 1 Arcanum Charge
- Casting a spell with a Secondary Slot grants you 2 Arcanum Charges
...
- If the cantrip deals damage, the target takes that damage in addition to the weapon's damage.
- If the cantrip forces a saving throw, the target automatically fails.
- If the cantrip requires an attack roll, it automatically hits
- If the cantrip has an area of effect, it is centered on the target, and you are unaffected by it.
...
- **Offense Stance.** Your attack rolls increase by +1 for each Arcanum Charge you hold.
- **Movement Stance.** Your speed increases by 5 feet for each Arcanum Charge you hold.
- **Spell Stance.** Your spell save DC increases by +1 for each Arcanum Charge you hold.
...
- **Empowered.** Add the spent charges to one damage roll of the spell.
- **Overwhelming.** The spell's saving throws are made with disadvantage.
- **Echoing.** The spell affects an additional target within range.

## Arcane Synthesis: 18

Your blade has become a permanent extension of your magical being. You gain the following benefits:

- When you roll initiative, you gain 2 Arcanum Charges.
- You can use Cantrip Strike without spending an Arcanum Charge once per turn.
...
At 1st level, you strike a bargain with an otherworldly being or concept that grants you power on your own terms. You choose the nature of your pact, which determines the fundamental expression of your warlock abilities.
...
You gain proficiency in Light armor, Medium Armor, Shields, and Martial Weapons.
...
- Meta-Magic Invocations (Sorcerer Boon only) modify your spells and require spending Invocation Charges.
- Mystic Invocations (Mystic Boon only) are martial feats. You may select any martial feat for which you meet the tier requirement. Using them requires spending Invocation Charges as normal for martial feats.
- Eldritch Invocations are available to both pacts and provide passive benefits or new capabilities. Some Eldritch Invocations require spending Invocation Charges.
...
- Casting a spell with a Primary Slot grants you 1 Invocation Charge
- Casting a spell with a Secondary Slot grants you 2 Invocation Charges
- Casting a spell with a Tertiary Slot grants you 3 Invocation Charges
...
_Sorcerer Boon only_

- **Distant Spell.** When you cast a spell that has a range of 5 feet or greater, you can spend 1 Invocation Charge to double the range. When you cast a spell that has a range of touch, you can spend 1 Invocation Charge to make the range 30 feet.
- **Empowered Spell.** When you roll damage for a spell, you can spend 1 Invocation Charge to reroll a number of the damage dice up to your Charisma modifier (minimum of one). You must use the new rolls.
- **Extended Spell.** When you cast a spell that has a duration of 1 minute or longer, you can spend 1 Invocation Charge to double the duration, up to a maximum duration of 24 hours.
- **Heightened Spell.** When you cast a spell that forces a creature to make a saving throw, you can spend 3 Invocation Charges to give one target of the spell disadvantage on its first saving throw against the spell.
- **Quickened Spell.** When you cast a spell with a Primary spell slot, you can spend 2 Invocation Charges to change the casting time to 1 action for this casting.
- **Sculpt Spells.** When you cast a spell that affects an area, you can spend 2 Invocation Charges to choose a number of creatures equal to your Charisma modifier in that area. Those creatures automatically succeed on their saving throws against the spell and take no damage if they would normally take half damage on a successful save.
- **Seeking Spell.** When you cast a spell that requires an attack roll, and you miss with that attack, you can spend 2 Invocation Charges to reroll the attack roll. You must use the new roll.
- **Subtle Spell.** When you cast a spell, you can spend 1 Invocation Charge to cast it without any somatic or verbal components.
- **Transmuted Spell.** When you cast a spell that deals acid, cold, fire, lightning, or thunder damage, you can spend 1 Invocation Charge to change the damage type to another type from that list.
- **Twinned Spell.** When you cast a spell that targets only one creature and doesn't have a range of self, you can spend Invocation Charges equal the Slot Tier (1,2,3) to target a second creature in range with the same spell.

## Eldritch Invocations

- **Agonizing Blasts.** When you cast a cantrip, add the number of Invocation Charges you are holding to the damage it deals on a hit. This does not spend the charges.
- **Beguiling Influence.** You gain proficiency in a skill.
- **Devil's Sight.** You can see normally in darkness, both magical and nonmagical, to a distance of 120 feet.
- **Eldritch Mind.** You can spend a Primary Spell Slot have advantage on Saving throws to maintain concentration on spells.
- **Eyes of the Rune Keeper.** You can read all writing.
- **Mythril Strikes.**When you make a weapon attack, it can be your choice of the weapon's damage type or force damage
- **One with Shadows.** When you are in an area of dim light or darkness, you can spend 1 Invocation Charge to become invisible until you move, take an action, or take damage.
- **Otherworldly Movement.** Your speed increases by 5 feet.
- **Precarious Intervention.** You gain resistance to one type of damage while below half health, you choose this damage type when you gain this feature.
- **Repel.** When you hit a creature with a cantrip, you can push the creature up to 10 feet away from you in a straight line.
- **Sign of the Shield.** For every Invocation Charge you would gain over your maximum, you gain a +1 to your AC until the beginning of your next turn.
- **Skinmold.** Your maximum hitpoints increase by your proficiency bonus.
...
Wizards often mean to emulate the great mages of old, Velthrea, Eriel, Challs
...
- You have advantage on Intelligence checks made to recall information about arcane, historical, or magical topics.
- You can read and write in three additional languages of your choice.

## Arcane Tradition: 3

At 3rd level, you choose an [Arcane Tradition](sc_wizard.html) that shapes your magical practice. Your choice grants you features at 3rd level, and then again at 6th, 10th, 14th, and 20th level.
...
Many classes gain the ability to cast spells. These spells can heal wounds, unleash destructive energy, manipulate the battlefield, gather information, or alter the world itself. While the source of magical power varies between classes, all spellcasting follows the same fundamental rules.

Every spell belongs to a level, ranging from simple magical techniques known as @Cantrips to powerful spells cast using @Tertiary Slots. More powerful magic often requires greater preparation, concentration, and commitment from the caster.

The sections that follow explain the universal rules for spellcasting, including spell slots, preparing spells, concentration, and the @Magic Action. Your class determines which spells you can learn, how many spell slots you possess, and which ability score you use to cast your spells.

---

## Learning and Preparing Spells

Each spellcasting class learns and prepares spells differently.

Some classes maintain a list of known spells that rarely changes. Other classes prepare spells from a larger list whenever they finish a @Long Rest.

Your class determines how many spells you know or prepare, as well as which spells are available to you.

Regardless of how you learn your spells, a spell must be known or prepared before you can cast it.

---

## Spellcasting Ability

Magic is shaped through force of mind, faith, instinct, study, or personality. Every spellcasting class uses a @Mental Modifier to determine the strength of its spells.

Your class determines which ability score serves as your Mental Modifier.

Many spells require a target to make a saving throw against your magic. The Difficulty Class for these saving throws is called your Spell Save DC.

**Spell Save DC = 8 + your @Proficiency Bonus + your Mental Modifier**

Some spells require you to make an attack roll. Your Spell Attack Modifier is calculated as follows:

**Spell Attack Modifier = your Proficiency Bonus + your Mental Modifier**

Whenever a spell refers to your spellcasting ability, use the Mental Modifier specified by your class.

---

## @Cantrips

Cantrips are simple spells that can be cast repeatedly without expending magical resources.

A Cantrip requires 1 action to cast unless its description states otherwise.

Because Cantrips do not consume spell slots, they form the foundation of many spellcasters' magical abilities and can be used whenever the situation demands.

Although Cantrips are the weakest form of magic, experienced spellcasters often rely on them throughout their careers.

---
## Casting Spells with Spell Slots

Unlike @Cantrips, most spells require the expenditure of a spell slot. Every spell has a level, and the spell slot used to cast it determines the level at which the spell is cast.

When you cast a spell using a spell slot, the spell is automatically cast at the level of that slot. If the spell has an "At Higher Levels" entry, apply any additional effects described there.

For example, if your @Primary Slots are 2nd-level slots and you cast _Burning Hands_, the spell is cast as a 2nd-level spell and gains the benefits listed in its "At Higher Levels" entry.

You may choose to cast a spell at its base level instead. When you do so, ignore any benefits granted by casting the spell at a higher level.

Some spells gain additional damage, duration, targets, or other benefits when cast at a higher level. These improvements are described in the spell's text.

If a spell does not include an "At Higher Levels" entry, casting it using a higher-level slot typically provides no additional benefit.

#### Example

A 6th level Druid has 2nd-level @Secondary Slots and has prepared _Cure Wounds_.

When they cast _Cure Wounds_ using a Secondary Slot, they may either:

- Cast the spell as a 2nd-level spell and apply its higher-level benefits.
- Cast the spell as a 1st-level spell and ignore its higher-level benefits.

In either case, the Secondary Slot is expended when the spell is cast.

### Example

A Wizard has 2nd-level @Primary Slots and prepares _Burning Hands_.

When they cast _Burning Hands_ using a Primary Slot, they may choose one of the following:

- Cast the spell as a 2nd-level spell, gaining the benefits listed in its "At Higher Levels" entry.
- Cast the spell as a 1st-level spell, ignoring any higher-level benefits.

The spell still expends a Primary Slot regardless of which option is chosen.


## @Primary Slots

Primary Slots represent a spellcaster's most accessible magical power. These spells can be cast reliably and frequently throughout an adventuring day.

To cast a spell using a Primary Slot, you must expend a Primary Slot of the spell's level or higher.

Casting a spell with a Primary Slot requires 2 actions unless the spell states otherwise.

Once a Primary Slot is expended, it cannot be used again until you finish a @Long Rest.

Your class determines how many Primary Slots you possess and the level of spells that can be cast using them.

---

## @Secondary Slots

Secondary Slots represent more potent magical power.

To cast a spell using a Secondary Slot, you must expend a Secondary Slot of the spell's level or higher.

Casting a spell with a Secondary Slot requires 2 actions unless the spell states otherwise.

Once a Secondary Slot is expended, it cannot be used again until you finish a @Long Rest.

Your class determines how many Secondary Slots you possess and the level of spells that can be cast using them.

While Secondary Slots are less common than Primary Slots, they often provide access to some of a spellcaster's most impactful abilities.
...
As an action, choose a spell you know or have prepared that can be cast using a Tertiary Slot. The spell becomes charged, but no spell slot is expended yet. 
...
At the start of one of your turns while the spell remains charged, you may spend 2 actions to cast it.

When the spell is cast, the Tertiary Slot is expended.

### Holding Power

You can maintain a charged spell for a number of turns equal to your @Mental Modifier, with a minimum of 1 turn.
...
Some spellcasting classes prepare their spells after a @Long Rest.

When you finish a Long Rest, you choose a number of spells from your class's spell list to prepare. The number of spells you can prepare is determined by your class.

Only prepared spells can be cast.

A prepared spell remains available until you change your prepared spells during a future Long Rest.

Classes that prepare spells are able to adapt their magical abilities to different situations by changing which spells they have prepared.

---

## Ritual Casting

Some spells possess the Ritual tag.

A spell with the Ritual tag can be cast without expending a spell slot if you have a feature that allows Ritual Casting.

Casting a spell as a ritual increases its casting time by 10 minutes.

A spell cast as a ritual functions normally in all other respects.

Because rituals do not consume spell slots, they are commonly used for utility magic, exploration, and information gathering when time is available.

---

## Concentration

Certain spells and magical effects require concentration to maintain.

A creature can concentrate on only one effect at a time. If you begin concentrating on a new effect, your previous concentration immediately ends. You can also end concentration at any time, even if it isn't your turn.
...
Whenever you take damage while concentrating, you must make a saving throw. The Ability score you use for this saving throw is your Mental Modifier.

The DC equals 10 or half the damage taken, whichever is higher.

On a failed save, your concentration ends immediately.

---

## @Magic Action

Casting a spell requires the Magic Action.

When you take the Magic Action, you cast a spell and resolve its effects as described in the spell's text. After resolving a spell cast through the Magic Action, you gain the @Fatigued condition. While @Fatigued, you do not add your ability modifier to:
...
How a mortal (or other being) casts their spells is dependent on their spell casting modifier, also called a Mental Modifier, along with their spell casting class.

**Druids and those who manipulate natural forces** cast their spells through their connection with the Primordial Titans of the world, and the continuation of their symbiotic relationship.

**Clerics and other divine casters** cast their spells by calling upon powerful beings in other planes and borrowing a fraction of their magical ability.

**Wizards and other studious mages** cast spells by mentally reciting various heuristics, each becoming more complex as the spells grow in power.

**Warlocks** gain their power from an outside source similar to Clerics and Druids, but theirs is typically more transactional or unintentional. A Warlock may draw upon their ancestral bloodline to cast spells of raw magic, invoke a pact they made with a Devil, or regrettably recite spells from a tome they are cursed to never be rid of.


___

In any case, a caster must draw upon some aspect of their mind which enhances their magics called a Mental Modifier.

**Intelligence** casting revolves around a studious Bard, Cleric, or Wizard's ability to go through the mental processes required to replicate complex spells, rituals or artforms.
Intelligence casters can usually point to a place in a journal they own which details the exact process they use to cast spells which was taught to them by a mentor, usually this is incomprehensible to other mortals.
...
The Weave is an imperceptible fabric which for the most part lies in its own dimension that lays upon our own. Arcane spellcasters like Wizards, Bards, and many Warlocks, can be seen tugging the strands of the Weave through the air as they form their spells. 


## Spellcasters in the World

While the Planescape is a magical one, the typical person on Gaia may only interact with real magic once or twice a year. Roughly 1% of mortals have magical capabilities, and most villages will have an elder cleric or shaman who is roughly equivalent to a level 3 or 4 spellcaster. The following points explain the rough amount of time it takes for a person of average intelligence, faith, or force of personality to learn spells of different levels. 
...
**Level 6-9 Spells**: Spells of these levels are entirely unobtainable for the vast majority of the population, there are only 4 mortals capable of casting spells at the 9th level.
