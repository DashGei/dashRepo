...
Once per turn when you take the Attack action and miss you immediately make another attack at disadvantage against the same target without spending an action. That attack must be made with another held weapon with the light property.
...
A creature firing a Hunker weapon doesn't suffer Disadvantage from the prone condition.
...
### Support Weapons
Employed by more organized militaries around the world. Squad weapons are expensive pieces of equipment which require special training to use. A creature untrained in a squad weapon is unable to use any of the features labeled with the squad weapon tag. A player can use a long rest of downtime to become trained in the weapon.

##### Heavy Crossbow
A heavy crossbow comes with the base weapon and one of two support kits, both of which may be used at the same time if available.

| Name           | Cost  | Damage       | Weight | Properties                                           |
| -------------- | ----- | ------------ | ------ | ---------------------------------------------------- |
| Heavy Crossbow | 75 GP | 2d6 Physical | 30 lbs | Ammunition, Heavy, Loading, Range 60/100, Two-Handed |
###### Sniper Kit {Squad Weapon Feature}
The crossbow comes with a pre-zeroed two-lens sight along with a folding stool.
...
###### Support Fire Kit {Squad Weapon Feature}
The crossbow comes with a folding stool and attachable top-mounted feed.

A creature wielding the weapon can take the utilize action to set up the Heavy Crossbow, which becomes fixed in place until a creature removes it with the utilize object action. While a creature is wielding the set up crossbow, they make attacks rolls at Advantage. 

A creature taking the help action with a creature using the set up crossbow gives the crossbow wielder an additional attack immediately as a reaction, and an additional attack as a free action on their turn.

#### Blunderbuss

| Name        | Cost   | Damage        | Weight | Properties                               |
| ----------- | ------ | ------------- | ------ | ---------------------------------------- |
| Blunderbuss | 150 GP | 1d10 Physical | 15 lbs | Ammunition, Heavy, Two-Handed, Matchlock |

###### Handcannon {Squad Weapon Feature}
You must spend two actions on your  turn to fire the blunderbuss. When you do so each creature in a 30-foot Cone originating from you must succeed on a Phys DC Dexterity saving throw, taking 1d10 physical damage on a failure or half as much on a successful one. 
...
To make a weapon attack, choose a target within the weapon's range and make an attack roll.

**Attack Roll = d20 + Physical Modifier + Proficiency Bonus**

If the result equals or exceeds the target's Armor Class, the attack hits.

On a hit, roll the weapon's damage die and apply any additional modifiers or effects.
...
- **Craft.** This entry lists what, if anything, you can craft with the tool. For crafting rules, see _Crafting Equipment_ later in the chapter.
...
- **Ability:** Charisma
- **Weight:** 3 lb.
- **Utilize:** Apply makeup and clothes (DC 10)
- **Craft:** Costume
...
When you take the **Attack** action, you can replace one of your attacks with throwing a flask of Alchemist's Fire.

Target one creature or object you can see within 20 feet of yourself. The target must succeed on a Phys DC Dexterity saving throw or take **1d4 Fire damage** and start burning (see the rules glossary).

# Ammunition (Varies)

Ammunition is required by a weapon that has the **Ammunition** property. A weapon's description specifies the type of ammunition used by the weapon.
...
As an **Action**, you can drink a vial of Antitoxin to gain Advantage on saving throws to avoid or end the **Poisoned** condition for **1 hour**.
...
While in a Bedroll, you automatically succeed on saving throws against extreme cold (see the _Dungeon Master's Guide_).
...
As a **Utilize** action, you can spread Caltrops from their bag to cover a **5-foot-square area** within 5 feet of yourself.

A creature that enters this area for the first time on a turn must succeed on a **DC 15 Dexterity saving throw** or:
...
For **1 hour**, a lit Candle sheds:

- **Bright Light:** 5-foot radius
    
- **Dim Light:** Additional 5 feet
...
A Map or Scroll Case holds up to:

- 10 sheets of paper, or
    
- 5 sheets of parchment

# Chain (5 GP)

As a **Utilize** action, you can wrap a Chain around an unwilling creature within 5 feet of yourself that has the **Grappled**, **Incapacitated**, or **Restrained** condition if you succeed on a **DC 13 Strength (Athletics)** check.

If the creature's legs are bound, the creature has the **Restrained** condition until it escapes.
...
As a **Utilize** action, you can use the Climber's Kit to anchor yourself.

While anchored:

- You can't fall more than 25 feet from the anchor point.
    
- You can't move more than 25 feet away without undoing the anchor as an Action.
...
A Druid or Ranger can use such an object as a **Spellcasting Focus**.
...
As a **Utilize** action, you can throw the Grappling Hook at a railing, ledge, or another catch within 50 feet of yourself.

The hook catches if you succeed on a **DC 13 Dexterity (Acrobatics)** check.
...
The table indicates whether a Holy Symbol must be held, worn, or borne on fabric or a Shield.
...
When you take the **Attack** action, you can replace one of your attacks with throwing a flask of Holy Water.

Target one creature you can see within 20 feet of yourself.

The target must succeed on a Dexterity saving throw (**DC = 8 + your Dexterity modifier + your Proficiency Bonus**) or take **2d8 Radiant damage** if it is a Fiend or an Undead.

# Hunting Trap (5 GP)

As a **Utilize** action, you can set a Hunting Trap.

A creature that steps on the pressure plate must succeed on a **DC 13 Dexterity saving throw** or:
...
Until freed, its movement is limited by the chain (typically 3 feet).

A creature can use an action to make a **DC 13 Strength (Athletics)** check to free itself or another creature within reach.

Each failed check deals **1 Piercing damage** to the trapped creature.

# Ink (10 GP)

Ink comes in a **1-ounce bottle**, providing enough ink to write about **500 pages**.
...
A Ladder is **10 feet tall**.

You must climb to move up or down it.

# Lamp (5 SP)

A Lamp burns Oil as fuel and casts:
...
A Bullseye Lantern burns Oil as fuel and casts:
...
A Hooded Lantern burns Oil as fuel and casts:
...
Without the key, a creature can use Thieves' Tools to pick the lock with a successful **DC 15 Dexterity (Sleight of Hand)** check.

# Magnifying Glass (100 GP)

A Magnifying Glass grants Advantage on any ability check made to appraise or inspect a highly detailed item.

Lighting a fire with a Magnifying Glass requires:
...
As a **Utilize** action, you can use Manacles to bind an unwilling Small or Medium creature within 5 feet of yourself that has the **Grappled**, **Incapacitated**, or **Restrained** condition if you succeed on a **DC 13 Dexterity (Sleight of Hand)** check.

While bound:

- The creature has Disadvantage on attack rolls.
    
- The creature is Restrained if the Manacles are attached to a fixed chain or hook.
    

Escaping requires a **DC 20 Dexterity (Sleight of Hand)** check.

Bursting the Manacles requires a **DC 25 Strength (Athletics)** check.

Each set of Manacles comes with a key. Without the key, a creature can use Thieves' Tools to pick the lock with a successful **DC 15 Dexterity (Sleight of Hand)** check.

# Map (1 GP)

If you consult an accurate Map, you gain a **+5 bonus** to Wisdom (Survival) checks made to find your way in the represented location.

# Mirror (5 GP)

A handheld steel Mirror is useful for:

- Personal cosmetics
    
- Peeking around corners
    
- Reflecting light as a signal
...
Target a creature you can see within 15 feet of yourself.

The target must succeed on a Dexterity saving throw (**DC = 8 + your Dexterity modifier + your Proficiency Bonus**) or gain the **Restrained** condition until it escapes.

The target automatically succeeds if it is **Huge or larger**.

To escape, the target or a creature within 5 feet of it must take an action and succeed on a **DC 10 Strength (Athletics)** check.

The Net can also be destroyed:
...
When you take the **Attack** action, you can replace one of your attacks with throwing an Oil flask.

Target one creature or object within 20 feet of yourself. The target must succeed on a **Phys DC Dexterity** saving throw or be covered in oil.
...
You can take the **Utilize** action to pour an Oil flask on level ground to cover a 5-foot-square area within 5 feet of yourself.

If lit, the oil burns until the end of the turn 2 rounds from when the oil was lit (12 seconds) and deals **5 Fire damage** to any creature that enters the area or ends its turn there.
...
Once lit, a flask of Oil burns for **6 hours** in a Lamp or Lantern. That duration doesn't need to be consecutive; you can extinguish the burning Oil (as a Utilize action) and rekindle it until it has burned for a total of 6 hours.
...
Perfume comes in a 4-ounce vial.
...
As an Action, you can use a vial of Basic Poison to coat one weapon or up to three pieces of ammunition.

A creature that takes Physical damage from the poisoned weapon or ammunition takes an extra **1d4 Poison damage**.

Once applied, the poison retains potency for **1 minute** or until its damage is dealt, whichever comes first.

# Pole (5 CP)

A Pole is **10 feet long**.

You can use it to touch something up to 10 feet away. If you must make a Strength (Athletics) check as part of a High or Long Jump, you can use the Pole to vault, giving yourself Advantage on the check.
...
This potion is a magic item.

As an Action, you can drink it or administer it to another creature within 5 feet of yourself.
...
When doing so, you gain a **+4 bonus** to the Athletics (Strength) check.

One other character can help you use the ram, giving you Advantage on this check.

# Rations (5 SP)

Rations consist of travel-ready food, including:
...
See **"Malnutrition"** in the rules glossary for the risks of not eating.
...
As a Utilize action, you can tie a knot with Rope if you succeed on a **DC 10 Dexterity (Sleight of Hand)** check.

The Rope can be burst with a successful **DC 20 Strength (Athletics)** check.

You can bind an unwilling creature with the Rope only if the creature has the **Grappled**, **Incapacitated**, or **Restrained** condition.
...
If the spell requires a saving throw or an attack roll:
...
As a Utilize action, you can use a blunt object, such as a Light Hammer, to hammer a spike into wood, earth, or a similar material.

You can do so to:

- Jam a door shut
    
- Tie a Rope to the Spike
    
- Tie a Chain to the Spike
...
A Tinderbox is a small container holding flint, fire steel, and tinder (usually dry cloth soaked in light oil) used to kindle a fire.

- Lighting a Candle, Lamp, Lantern, Torch, or anything else with exposed fuel takes an **Action**.
    
- Lighting any other fire takes **1 minute**.

# Torch (1 CP)

A Torch burns for **1 hour**, casting:

- **Bright Light:** 20-foot radius
    
- **Dim Light:** Additional 20 feet

When you take the Attack action, you can attack with the Torch, using it as a **Simple Melee weapon**.

On a hit, the target takes **1 d4 Fire damage**.
...
If you don't drink sufficient water, you risk dehydration (see the rules glossary).
...
The **Mounts and Other Animals** table shows each animal's carrying capacity. See appendix B for the animals' stat blocks.
...
If multiple animals pull the same vehicle, add their carrying capacities together.

## Barding

Barding is armor designed for a mount.

Any type of armor on the Armor table in this chapter can be purchased as barding.

- **Cost:** Four times the normal cost
    
- **Weight:** Twice the normal weight
...
- Any other equipment needed to use the saddle
    
- **Military Saddle:** Grants Advantage on ability checks made to remain mounted.
    
- **Exotic Saddle:** Required for riding an aquatic or flying mount.
...
A ship sailing against a strong wind moves at **half speed**.

In a dead calm (no wind), waterborne ships can't move under sail and must be rowed.
...
A ship larger than a Keelboat or Rowboat needs a crew of skilled hirelings (see **Services**) to function.

The minimum number of skilled hirelings needed to crew a ship depends on the type of ship, as shown in the table.

## Passengers

The table lists the number of Small and Medium passengers the ship can accommodate using hammocks.

A ship outfitted with private accommodations can carry **one-fifth as many passengers**.

Typical passage costs:

- Hammock: **5 SP per day**
    
- Small private cabin: **2 GP per day**
    

Prices can vary from ship to ship.

## Damage Threshold

If a vehicle has a damage threshold (see the rules glossary), it is noted in the table.

## Ship Repair

Repairs to a damaged ship can be made while the vessel is berthed.

For each **1 Hit Point** repaired:
...
Lifestyle expenses summarize the cost of living in a fantasy world.
...
You survive via chance and charity.

You're often exposed to natural dangers as a result of sleeping outside.

### Squalid (1 SP per Day)

You spend the bare minimum for your necessities.

You might be exposed to unhealthy conditions and opportunistic criminals.
...
You pay for the best and might have a staff that supports your lifestyle.

Others notice your wealth and might encourage you to share it, either legally or otherwise.

# Food, Drink, and Lodging

The following table gives prices for food and a single night's lodging.

Daily lodging and meals are already included in lifestyle expenses.
...
Drivers or crew hired to conduct passengers to their destinations charge the following rates, plus any tolls or additional expenses.
...
Skilled hirelings include anyone hired to perform a service that involves a proficiency, such as:
...
Untrained hirelings perform work requiring no special proficiencies, such as laborers and porters.
...
Most settlements contain individuals willing to cast spells in exchange for payment.

If a spell requires expensive material components, add the cost of those components to the listed service cost.

The higher the spell level, the harder it is to find a caster.
...
|1st|Village, town, or city|50 GP|
|2nd|Village, town, or city|200 GP|
|3rd|Town or city only|300 GP|
|4th–5th|Town or city only|2,000 GP|
|6th–8th|City only|20,000 GP|
|9th|City only|100,000 GP|
