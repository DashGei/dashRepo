...
| ----- | ----------------- | ------------------------------------------ |
| 1st   | +1                | Spellcraft, Arcane Recovery                |
| 2nd   | +2                |                                            |
| 3rd   | +2                | Ritual Caster                              |
| 4th   | +2                |                                            |
| 5th   | +3                | Magic Fatigue Resistance, Cantrip Formulas |
| 6th   | +3                |                                            |
| 7th   | +3                |                                            |
| 8th   | +3                |                                            |
| 9th   | +4                |                                            |
...
Some of your abilities will require your **Mental Modifier** or **Physical Modifier**.
...
You prepare the list of wizard spells that are available for you to cast. To do so, choose a number of wizard spells from your spellbook equal to your **Mental Modifier** + your wizard level (minimum of one spell). The spells must be of a level for which you have spell slots.

**Spellcasting Economy.** Casting a spell with a **Cantrip** requires one action. Casting a spell with a **Primary Spell Slot** or **Secondary Spell Slot** requires two actions.
...
**Spellcasting Ability.** Intelligence is your spellcasting ability for your wizard spells. The DC for your spell saving throws equals your **Mental DC** (8 + your **Proficiency Bonus** + your **Mental Modifier**).
...
| Level | Primary Slots | Primary Level | Secondary Slots | Secondary Level | Tertiary Slots | Tertiary Level |
| ----- | ------------- | ------------- | --------------- | --------------- | -------------- | -------------- |
| 1st   | 0             | —             | 2               | 1st             | 0              | —              |
| 2nd   | 4             | 1st           | 2               | 1st             | 0              | —              |
...
You have a number of **Arcane Charges** equal to your **Proficiency Bonus**. You regain all expended charges when you finish a long rest.

When you finish a short rest, you can expend these charges to recover spell slots. Recovering a **Primary Spell Slot** costs 1 charge; recovering a **Secondary Spell Slot** costs 2 charges. You may do this multiple times, expending charges as available.
...
_You choose an [Arcane Tradition](https://dashgei.github.io/dashRepo/sc_wizard.html) that shapes your magical practice._ Your choice grants you features at 3rd level, and then again at 6th, 10th, 14th, and 20th level.

## Tertiary Slots: 3

You gain access to **tertiary spell slots**, as shown on the Spellcasting table. Refer to the Spellcasting section for the rules governing the casting of tertiary slot spells.
...
Whenever you finish a long rest and consult your spellbook, you can replace one wizard cantrip you know with another cantrip from the wizard spell list.
